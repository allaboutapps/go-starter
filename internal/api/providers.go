...
// PROVIDERS - define here only providers that for various reasons (e.g. cyclic dependency) can't live in their corresponsing packages
...
func NewAuthService(config config.Server, db *sql.DB, clock time2.Clock) AuthService {
