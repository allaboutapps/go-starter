...
var (
	...
	userColumnsWithoutDefault = []string{"username", "password", "google_info", "facebook_info", "is_active", "scopes", "last_authenticated_at", "created_at", "updated_at"}
	userColumnsWithDefault    = []string{"id", "google_id", "facebook_id"}
