...
ALTER TABLE role_notification_templates
    ADD CONSTRAINT role_notification_templates_role_id_fkey FOREIGN KEY (role_id) REFERENCES roles (id) ON UPDATE CASCADE ON DELETE CASCADE;
