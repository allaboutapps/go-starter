...
var (
	userAllColumns            = []string{"id", "username", "password", "google_id", "google_info", "facebook_id", "facebook_info", "is_active", "scopes", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"username", "password", "google_info", "facebook_info", "scopes", "created_at", "updated_at"}
