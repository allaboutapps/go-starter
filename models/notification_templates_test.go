...
func notificationTemplateBeforeInsertHook(ctx context.Context, e boil.ContextExecutor, o *NotificationTemplate) error {
	*o = NotificationTemplate{}
	return nil
}

func notificationTemplateAfterInsertHook(ctx context.Context, e boil.ContextExecutor, o *NotificationTemplate) error {
	*o = NotificationTemplate{}
	return nil
}

func notificationTemplateAfterSelectHook(ctx context.Context, e boil.ContextExecutor, o *NotificationTemplate) error {
	*o = NotificationTemplate{}
	return nil
}

func notificationTemplateBeforeUpdateHook(ctx context.Context, e boil.ContextExecutor, o *NotificationTemplate) error {
	*o = NotificationTemplate{}
	return nil
}

func notificationTemplateAfterUpdateHook(ctx context.Context, e boil.ContextExecutor, o *NotificationTemplate) error {
	*o = NotificationTemplate{}
	return nil
}

func notificationTemplateBeforeDeleteHook(ctx context.Context, e boil.ContextExecutor, o *NotificationTemplate) error {
	*o = NotificationTemplate{}
	return nil
}

func notificationTemplateAfterDeleteHook(ctx context.Context, e boil.ContextExecutor, o *NotificationTemplate) error {
	*o = NotificationTemplate{}
	return nil
}

func notificationTemplateBeforeUpsertHook(ctx context.Context, e boil.ContextExecutor, o *NotificationTemplate) error {
	*o = NotificationTemplate{}
	return nil
}

func notificationTemplateAfterUpsertHook(ctx context.Context, e boil.ContextExecutor, o *NotificationTemplate) error {
	*o = NotificationTemplate{}
	return nil
}

func testNotificationTemplatesHooks(t *testing.T) {
	t.Parallel()

	var err error

	ctx := context.Background()
	empty := &NotificationTemplate{}
	o := &NotificationTemplate{}

	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, o, notificationTemplateDBTypes, false); err != nil {
		t.Errorf("Unable to randomize NotificationTemplate object: %s", err)
	}

	AddNotificationTemplateHook(boil.BeforeInsertHook, notificationTemplateBeforeInsertHook)
	...
	notificationTemplateBeforeInsertHooks = []NotificationTemplateHook{}

	AddNotificationTemplateHook(boil.AfterInsertHook, notificationTemplateAfterInsertHook)
	...
	notificationTemplateAfterInsertHooks = []NotificationTemplateHook{}

	AddNotificationTemplateHook(boil.AfterSelectHook, notificationTemplateAfterSelectHook)
	...
	notificationTemplateAfterSelectHooks = []NotificationTemplateHook{}

	AddNotificationTemplateHook(boil.BeforeUpdateHook, notificationTemplateBeforeUpdateHook)
	...
	notificationTemplateBeforeUpdateHooks = []NotificationTemplateHook{}

	AddNotificationTemplateHook(boil.AfterUpdateHook, notificationTemplateAfterUpdateHook)
	...
	notificationTemplateAfterUpdateHooks = []NotificationTemplateHook{}

	AddNotificationTemplateHook(boil.BeforeDeleteHook, notificationTemplateBeforeDeleteHook)
	...
	notificationTemplateBeforeDeleteHooks = []NotificationTemplateHook{}

	AddNotificationTemplateHook(boil.AfterDeleteHook, notificationTemplateAfterDeleteHook)
	...
	notificationTemplateAfterDeleteHooks = []NotificationTemplateHook{}

	AddNotificationTemplateHook(boil.BeforeUpsertHook, notificationTemplateBeforeUpsertHook)
	...
	notificationTemplateBeforeUpsertHooks = []NotificationTemplateHook{}

	AddNotificationTemplateHook(boil.AfterUpsertHook, notificationTemplateAfterUpsertHook)
	...
	notificationTemplateAfterUpsertHooks = []NotificationTemplateHook{}
}
