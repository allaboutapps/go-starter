...
func applicantTagBeforeInsertHook(ctx context.Context, e boil.ContextExecutor, o *ApplicantTag) error {
	*o = ApplicantTag{}
	return nil
}

func applicantTagAfterInsertHook(ctx context.Context, e boil.ContextExecutor, o *ApplicantTag) error {
	*o = ApplicantTag{}
	return nil
}

func applicantTagAfterSelectHook(ctx context.Context, e boil.ContextExecutor, o *ApplicantTag) error {
	*o = ApplicantTag{}
	return nil
}

func applicantTagBeforeUpdateHook(ctx context.Context, e boil.ContextExecutor, o *ApplicantTag) error {
	*o = ApplicantTag{}
	return nil
}

func applicantTagAfterUpdateHook(ctx context.Context, e boil.ContextExecutor, o *ApplicantTag) error {
	*o = ApplicantTag{}
	return nil
}

func applicantTagBeforeDeleteHook(ctx context.Context, e boil.ContextExecutor, o *ApplicantTag) error {
	*o = ApplicantTag{}
	return nil
}

func applicantTagAfterDeleteHook(ctx context.Context, e boil.ContextExecutor, o *ApplicantTag) error {
	*o = ApplicantTag{}
	return nil
}

func applicantTagBeforeUpsertHook(ctx context.Context, e boil.ContextExecutor, o *ApplicantTag) error {
	*o = ApplicantTag{}
	return nil
}

func applicantTagAfterUpsertHook(ctx context.Context, e boil.ContextExecutor, o *ApplicantTag) error {
	*o = ApplicantTag{}
	return nil
}

func testApplicantTagsHooks(t *testing.T) {
	t.Parallel()
	...
	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, o, applicantTagDBTypes, false); err != nil {
		t.Errorf("Unable to randomize ApplicantTag object: %s", err)
	}

	AddApplicantTagHook(boil.BeforeInsertHook, applicantTagBeforeInsertHook)
	...
	applicantTagBeforeInsertHooks = []ApplicantTagHook{}

	AddApplicantTagHook(boil.AfterInsertHook, applicantTagAfterInsertHook)
	...
	applicantTagAfterInsertHooks = []ApplicantTagHook{}

	AddApplicantTagHook(boil.AfterSelectHook, applicantTagAfterSelectHook)
	...
	applicantTagAfterSelectHooks = []ApplicantTagHook{}

	AddApplicantTagHook(boil.BeforeUpdateHook, applicantTagBeforeUpdateHook)
	...
	applicantTagBeforeUpdateHooks = []ApplicantTagHook{}

	AddApplicantTagHook(boil.AfterUpdateHook, applicantTagAfterUpdateHook)
	...
	applicantTagAfterUpdateHooks = []ApplicantTagHook{}

	AddApplicantTagHook(boil.BeforeDeleteHook, applicantTagBeforeDeleteHook)
	...
	applicantTagBeforeDeleteHooks = []ApplicantTagHook{}

	AddApplicantTagHook(boil.AfterDeleteHook, applicantTagAfterDeleteHook)
	...
	applicantTagAfterDeleteHooks = []ApplicantTagHook{}

	AddApplicantTagHook(boil.BeforeUpsertHook, applicantTagBeforeUpsertHook)
	...
	applicantTagBeforeUpsertHooks = []ApplicantTagHook{}

	AddApplicantTagHook(boil.AfterUpsertHook, applicantTagAfterUpsertHook)
	...
	applicantTagAfterUpsertHooks = []ApplicantTagHook{}
}
