...
func pilotLanguageBeforeInsertHook(ctx context.Context, e boil.ContextExecutor, o *PilotLanguage) error {
	*o = PilotLanguage{}
	return nil
}

func pilotLanguageAfterInsertHook(ctx context.Context, e boil.ContextExecutor, o *PilotLanguage) error {
	*o = PilotLanguage{}
	return nil
}

func pilotLanguageAfterSelectHook(ctx context.Context, e boil.ContextExecutor, o *PilotLanguage) error {
	*o = PilotLanguage{}
	return nil
}

func pilotLanguageBeforeUpdateHook(ctx context.Context, e boil.ContextExecutor, o *PilotLanguage) error {
	*o = PilotLanguage{}
	return nil
}

func pilotLanguageAfterUpdateHook(ctx context.Context, e boil.ContextExecutor, o *PilotLanguage) error {
	*o = PilotLanguage{}
	return nil
}

func pilotLanguageBeforeDeleteHook(ctx context.Context, e boil.ContextExecutor, o *PilotLanguage) error {
	*o = PilotLanguage{}
	return nil
}

func pilotLanguageAfterDeleteHook(ctx context.Context, e boil.ContextExecutor, o *PilotLanguage) error {
	*o = PilotLanguage{}
	return nil
}

func pilotLanguageBeforeUpsertHook(ctx context.Context, e boil.ContextExecutor, o *PilotLanguage) error {
	*o = PilotLanguage{}
	return nil
}

func pilotLanguageAfterUpsertHook(ctx context.Context, e boil.ContextExecutor, o *PilotLanguage) error {
	*o = PilotLanguage{}
	return nil
}

func testPilotLanguagesHooks(t *testing.T) {
	t.Parallel()
	...
	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, o, pilotLanguageDBTypes, false); err != nil {
		t.Errorf("Unable to randomize PilotLanguage object: %s", err)
	}

	AddPilotLanguageHook(boil.BeforeInsertHook, pilotLanguageBeforeInsertHook)
	...
	pilotLanguageBeforeInsertHooks = []PilotLanguageHook{}

	AddPilotLanguageHook(boil.AfterInsertHook, pilotLanguageAfterInsertHook)
	...
	pilotLanguageAfterInsertHooks = []PilotLanguageHook{}

	AddPilotLanguageHook(boil.AfterSelectHook, pilotLanguageAfterSelectHook)
	...
	pilotLanguageAfterSelectHooks = []PilotLanguageHook{}

	AddPilotLanguageHook(boil.BeforeUpdateHook, pilotLanguageBeforeUpdateHook)
	...
	pilotLanguageBeforeUpdateHooks = []PilotLanguageHook{}

	AddPilotLanguageHook(boil.AfterUpdateHook, pilotLanguageAfterUpdateHook)
	...
	pilotLanguageAfterUpdateHooks = []PilotLanguageHook{}

	AddPilotLanguageHook(boil.BeforeDeleteHook, pilotLanguageBeforeDeleteHook)
	...
	pilotLanguageBeforeDeleteHooks = []PilotLanguageHook{}

	AddPilotLanguageHook(boil.AfterDeleteHook, pilotLanguageAfterDeleteHook)
	...
	pilotLanguageAfterDeleteHooks = []PilotLanguageHook{}

	AddPilotLanguageHook(boil.BeforeUpsertHook, pilotLanguageBeforeUpsertHook)
	...
	pilotLanguageBeforeUpsertHooks = []PilotLanguageHook{}

	AddPilotLanguageHook(boil.AfterUpsertHook, pilotLanguageAfterUpsertHook)
	...
	pilotLanguageAfterUpsertHooks = []PilotLanguageHook{}
}
