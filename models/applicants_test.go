...
func applicantBeforeInsertHook(ctx context.Context, e boil.ContextExecutor, o *Applicant) error {
	*o = Applicant{}
	return nil
}

func applicantAfterInsertHook(ctx context.Context, e boil.ContextExecutor, o *Applicant) error {
	*o = Applicant{}
	return nil
}

func applicantAfterSelectHook(ctx context.Context, e boil.ContextExecutor, o *Applicant) error {
	*o = Applicant{}
	return nil
}

func applicantBeforeUpdateHook(ctx context.Context, e boil.ContextExecutor, o *Applicant) error {
	*o = Applicant{}
	return nil
}

func applicantAfterUpdateHook(ctx context.Context, e boil.ContextExecutor, o *Applicant) error {
	*o = Applicant{}
	return nil
}

func applicantBeforeDeleteHook(ctx context.Context, e boil.ContextExecutor, o *Applicant) error {
	*o = Applicant{}
	return nil
}

func applicantAfterDeleteHook(ctx context.Context, e boil.ContextExecutor, o *Applicant) error {
	*o = Applicant{}
	return nil
}

func applicantBeforeUpsertHook(ctx context.Context, e boil.ContextExecutor, o *Applicant) error {
	*o = Applicant{}
	return nil
}

func applicantAfterUpsertHook(ctx context.Context, e boil.ContextExecutor, o *Applicant) error {
	*o = Applicant{}
	return nil
}

func testApplicantsHooks(t *testing.T) {
	t.Parallel()
	...
	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, o, applicantDBTypes, false); err != nil {
		t.Errorf("Unable to randomize Applicant object: %s", err)
	}

	AddApplicantHook(boil.BeforeInsertHook, applicantBeforeInsertHook)
	...
	applicantBeforeInsertHooks = []ApplicantHook{}

	AddApplicantHook(boil.AfterInsertHook, applicantAfterInsertHook)
	...
	applicantAfterInsertHooks = []ApplicantHook{}

	AddApplicantHook(boil.AfterSelectHook, applicantAfterSelectHook)
	...
	applicantAfterSelectHooks = []ApplicantHook{}

	AddApplicantHook(boil.BeforeUpdateHook, applicantBeforeUpdateHook)
	...
	applicantBeforeUpdateHooks = []ApplicantHook{}

	AddApplicantHook(boil.AfterUpdateHook, applicantAfterUpdateHook)
	...
	applicantAfterUpdateHooks = []ApplicantHook{}

	AddApplicantHook(boil.BeforeDeleteHook, applicantBeforeDeleteHook)
	...
	applicantBeforeDeleteHooks = []ApplicantHook{}

	AddApplicantHook(boil.AfterDeleteHook, applicantAfterDeleteHook)
	...
	applicantAfterDeleteHooks = []ApplicantHook{}

	AddApplicantHook(boil.BeforeUpsertHook, applicantBeforeUpsertHook)
	...
	applicantBeforeUpsertHooks = []ApplicantHook{}

	AddApplicantHook(boil.AfterUpsertHook, applicantAfterUpsertHook)
	...
	applicantAfterUpsertHooks = []ApplicantHook{}
}
