...
type AppUserProfile struct {
	...
	HasGDPROptOut   bool      `boil:"has_gdpr_opt_out" json:"has_gdpr_opt_out" toml:"has_gdpr_opt_out" yaml:"has_gdpr_opt_out"`
...
var AppUserProfileColumns = struct {
	UserID          string
	HasGDPROptOut   string
	LegalAcceptedAt string
	CreatedAt       string
	UpdatedAt       string
}{
	UserID:          "user_id",
	HasGDPROptOut:   "has_gdpr_opt_out",
...
var (
	appUserProfileAllColumns            = []string{"user_id", "has_gdpr_opt_out", "legal_accepted_at", "created_at", "updated_at"}
	appUserProfileColumnsWithoutDefault = []string{"user_id", "legal_accepted_at", "created_at", "updated_at"}
	appUserProfileColumnsWithDefault    = []string{"has_gdpr_opt_out"}
